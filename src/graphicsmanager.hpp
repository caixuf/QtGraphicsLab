...
public:
    GraphicsManager(QObject *parent = nullptr) : QObject(parent) {
        ...
        t = new myGraphicRectItem(QSizeF(200, 140), ResourceManager::instance().getImagePath(ResourceManager::DEFAULT_RECT));
        t1 = new myGraphicRectItem(QSizeF(200, 140), ResourceManager::instance().getImagePath(ResourceManager::DEFAULT_RECT));
